...
components/
  ...
  step/           # Step 1-4 domain content, one folder per step
    ...
    review/         # Step 4's in-wizard content — ReviewSection.vue, ...
  order-summary/  # shared by Step 3 + Step 4 — OrderSummary.vue
  result/         # NOT under step/ — the post-submit screen, a sibling of
                  # the whole wizard (see journal 05), not step content:
                  # Success.vue
```
