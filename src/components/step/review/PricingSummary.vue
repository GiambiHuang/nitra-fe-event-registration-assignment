...
<template>
  <div class="p-5 rounded-md border border-neutral-muted border-solid bg-surface-l1">
    ...
    <div
      v-if="!summary"
      class="mt-2 text-body-sm text-neutral-muted"
    >
      Loading…
    </div>
    <div
    ...
    >
      ...
      <div
        ...
        :key="line.id"
        class="flex items-start flex-nowrap gap-x-2 justify-between text-body-sm text-neutral-muted"
      >
      ...
      <div
        ...
        class="flex items-start flex-nowrap gap-x-2 justify-between text-body-xs text-brand-emphasis"
      >
